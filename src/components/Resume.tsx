...
export default function Resume({}: Props) {
    return <div>
        <section className="bg-blue-50  lg:rounded-2xl dark:bg-[#111111]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-6 ">
                            ...
                            {/*<div>
                                <div className="flex items-center space-x-2 mb-4 ">
                                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 384 512"
                                         className="text-4xl text-[#F95054]" height="1em" width="1em"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <h4 style={{fontSize: '1.625rem', fontWeight: 700}}
                                        className={'dark:text-white'}>Awards</h4></div>
                                <div
                                    className="py-4 pl-5 pr-3 space-y-2 mb-6 rounded-lg  dark:border-[#212425] dark:border-2"
                                    style={{background: "rgb(252, 244, 255)"}}><span
                                    className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2015-2017</span><h3
                                    className="text-xl dark:text-white"> Graphic Designer</h3><p
                                    className="dark:text-[#b7b7b7]">Web
                                    Graphy, Los Angeles, CA</p></div>
                                <div
                                    className="py-4 pl-5 pr-3 space-y-2 rounded-lg  mb-6 dark:border-[#212425] dark:border-2"
                                    style={{background: "rgb(252, 249, 242)"}}><span
                                    className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2014 - 2015</span><h3
                                    className="text-xl dark:text-white">Jr. Web Developer</h3><p
                                    className="dark:text-[#b7b7b7]">Creative Gigs.</p></div>
                                <div
                                    className="py-4 pl-5 pr-3 space-y-2 rounded-lg  dark:border-[#212425] dark:border-2"
                                    style={{background: "rgb(252, 244, 255)"}}><span
                                    className="text-tiny text-gray-lite dark:text-[#b7b7b7]">2015-2017</span><h3
                                    className="text-xl dark:text-white">Best Freelancer</h3><p
                                    className="dark:text-[#b7b7b7]">Fiver &amp; Upwork Level 2 &amp; Top Rated</p></div>
                            </div>*/}
                        </div>
                    </div>
                </div>
                        ...
                        {/*<div className="col-span-1"><h4 className="text-3xl dark:text-white font-medium mb-6">Working
                            ...
                            <div className=" mb-7">
                                <div className="flex justify-between py-1"><span
                                    className=" text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Web Design</span><span
         ...
         L 99.5,0.5" strokeLinecap="round" stroke="#EDF2F2" strokeWidth="1" fillOpacity="0"></path>
                                    <path className="rc-progress-line-path" d="M 0.5,0.5
         L 99.5,0.5" strokeLinecap="round" stroke="#FF6464" strokeWidth="1" fillOpacity="0"
                                          style={{
                                              strokeDasharray: "74.25px, 100px 0.3s ease 0s",
                                              strokeDashoffset: "0px",
                                              transition: "strokeDashoffset 0.3s ease 0s",
                            ...
                            <div className=" mb-7">
                                <div className="flex justify-between py-1"><span
                                    className=" text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Mobile App </span><span
         ...
         L 99.5,0.5" strokeLinecap="round" stroke="#EDF2F2" strokeWidth="1" fillOpacity="0"></path>
                                    <path className="rc-progress-line-path" d="M 0.5,0.5
         L 99.5,0.5" strokeLinecap="round" stroke="#9272D4" strokeWidth="1" fillOpacity="0"
                                          style={{
                                              strokeDasharray: "74.25px, 100px 0.3s ease 0s",
                                              strokeDashoffset: "0px",
                                              transition: "strokeDashoffset 0.3s ease 0s",
                            ...
                            <div className=" mb-7">
                                <div className="flex justify-between py-1"><span
                                    className=" text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Illustrator</span><span
         ...
         L 99.5,0.5" strokeLinecap="round" stroke="#5185D4" strokeWidth="1" fillOpacity="0"
                            ...
                            <div className=" mb-7">
                                <div className="flex justify-between py-1"><span
                                    className=" text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Photoshope</span><span
         ...
         L 99.5,0.5" strokeLinecap="round" stroke="#EDF2F2" strokeWidth="1" fillOpacity="0"></path>
                                    <path className="rc-progress-line-path" d="M 0.5,0.5
         L 99.5,0.5" strokeLinecap="round" stroke="#CA56F2" strokeWidth="1" fillOpacity="0"
                                          style={{
                                              strokeDasharray: "74.25px, 100px 0.3s ease 0s",
                                              strokeDashoffset: "0px",
                                              transition: "strokeDashoffset 0.3s ease 0s",
