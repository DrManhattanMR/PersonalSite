          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item mt-1">
                <a
                  className="rounded-md px-3 py-2 flex items-center font-poppins  bg-white text-gray-lite font-medium mx-2.5 leading-snug hover:text-white hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] dark:text-[#001C64]   transition-all duration-300 ease-in-out"
                  href="/"
                >
